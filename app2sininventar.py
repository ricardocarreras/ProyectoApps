...
def generar_publicacion_con_gpt(tema, palabras_clave, matiz, fechahoy, urlnoticia1, urlnoticia2):
    try:
        ...
        response = client.completions.create(
            ...
            max_tokens=3300  # Ajusta según la longitud deseada
        )
